(function () {
    ...
    angular.module('orderCloud.customsdk', ['ngResource', 'ngCookies'])
        .factory('FullOrderCloud', orderCloud);
    ...
    function orderCloud($q, $resource, $cookieStore, $injector, appname, apiurl, authurl, clientid) {
        ...
        function Addresses() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/addresses', {
            ...
            function _get(addressID, buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID/addresses/:addressID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'addressID': addressID
                }, null);
            }
            ...
            function _create(address, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/addresses', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, address);
            }

            function _update(addressID, address, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/addresses/:addressID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'addressID': addressID
                }, address);
            }
            ...
            function _patch(addressID, address, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/addresses/:addressID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'addressID': addressID
                }, address);
            }
            ...
            function _delete(addressID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/addresses/:addressID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'addressID': addressID
                }, null);
            }
            ...
            function _listassignments(addressID, userID, userGroupID, level, isShipping, isBilling, page, pageSize, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/addresses/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'addressID': addressID,
                    'userID': userID,
            ...
            function _deleteassignment(addressID, userID, userGroupID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/addresses/:addressID/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'addressID': addressID,
                    'userID': userID,
                    'userGroupID': userGroupID
            ...
            function _saveassignment(assignment, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/addresses/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, assignment);
            }
        }
        ...
        function AdminAddresses() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/addresses', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _get(addressID) {
                ...
                return startApiLoop('GET', '/v1/addresses/:addressID', {
                    'addressID': addressID
                }, null);
            }

            function _create(address) {
                return startApiLoop('POST', '/v1/addresses', null, address);
            }

            function _update(addressID, address) {
                return startApiLoop('PUT', '/v1/addresses/:addressID', {
                    'addressID': addressID
                }, address);
            }

            function _patch(addressID, address) {
                return startApiLoop('PATCH', '/v1/addresses/:addressID', {
                    'addressID': addressID
                }, address);
            }

            function _delete(addressID) {
                return startApiLoop('DELETE', '/v1/addresses/:addressID', {
                    'addressID': addressID
                }, null);
            }
        }
        ...
        function AdminUsers() {
            ...
            function _get(userID) {
                ...
                return startApiLoop('GET', '/v1/adminusers/:userID', {
                    'userID': userID
                }, null);
            }

            function _create(user) {
                return startApiLoop('POST', '/v1/adminusers', null, user);
            }

            function _update(userID, user) {
                return startApiLoop('PUT', '/v1/adminusers/:userID', {
                    'userID': userID
                }, user);
            }

            function _patch(userID, user) {
                return startApiLoop('PATCH', '/v1/adminusers/:userID', {
                    'userID': userID
                }, user);
            }

            function _list(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/adminusers', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _delete(userID) {
                return startApiLoop('DELETE', '/v1/adminusers/:userID', {
                    'userID': userID
                }, null);
            }
        }
        ...
        function AdminUserGroups() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/usergroups', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _get(userGroupID) {
                ...
                return startApiLoop('GET', '/v1/usergroups/:userGroupID', {
                    'userGroupID': userGroupID
                }, null);
            }

            function _update(userGroupID, group) {
                return startApiLoop('PUT', '/v1/usergroups/:userGroupID', {
                    'userGroupID': userGroupID
                }, group);
            }

            function _patch(userGroupID, group) {
                return startApiLoop('PATCH', '/v1/usergroups/:userGroupID', {
                    'userGroupID': userGroupID
                }, group);
            }

            function _create(group) {
                return startApiLoop('POST', '/v1/usergroups', null, group);
            }

            function _delete(userGroupID) {
                return startApiLoop('DELETE', '/v1/usergroups/:userGroupID', {
                    'userGroupID': userGroupID
                }, null);
            }

            function _listuserassignments(userGroupID, userID, page, pageSize) {
                return startApiLoop('GET', '/v1/usergroups/assignments', {
                    'userGroupID': userGroupID,
                    'userID': userID,
                    'page': page,
                    'pageSize': pageSize
            ...
            function _deleteuserassignment(userGroupID, userID) {
                return startApiLoop('DELETE', '/v1/usergroups/:userGroupID/assignments/:userID', {
                    'userGroupID': userGroupID,
                    'userID': userID
                }, null);
            }
            ...
            function _saveuserassignment(userGroupAssignment) {
                return startApiLoop('POST', '/v1/usergroups/assignments', null, userGroupAssignment);
            }
        }
        ...
        function Catalogs() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/catalogs', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _create(catalog) {
                return startApiLoop('POST', '/v1/catalogs', null, catalog);
            }
            ...
            function _get(catalogID) {
                ...
                return startApiLoop('GET', '/v1/catalogs/:catalogID', {
                    'catalogID': catalogID
                }, null);
            }

            function _update(catalog, catalogID) {
                return startApiLoop('PUT', '/v1/catalogs/:catalogID', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get()
                }, catalog);
            }

            function _patch(partialCatalog, catalogID) {
                return startApiLoop('PATCH', '/v1/catalogs/:catalogID', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get()
                }, partialCatalog);
            }

            function _delete(catalogID) {
                return startApiLoop('DELETE', '/v1/catalogs/:catalogID', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get()
                }, null);
            }

            function _listassignments(page, pageSize, buyerID, catalogID) {
                return startApiLoop('GET', '/v1/catalogs/assignments', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get(),
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'page': page,
                    'pageSize': pageSize
            ...
            function _saveassignment(assignment) {
                return startApiLoop('POST', '/v1/catalogs/assignments', null, assignment);
            }

            function _deleteassignment(buyerID, catalogID) {
                return startApiLoop('DELETE', '/v1/catalogs/:catalogID/assignments', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get(),
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, null);
            }
        ...
        function ApprovalRules() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/approvalrules', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
            ...
            function _get(approvalRuleID, buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID/approvalrules/:approvalRuleID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
            ...
            function _create(approvalRule, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/approvalrules', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, approvalRule);
            }

            function _update(approvalRuleID, approvalRule, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/approvalrules/:approvalRuleID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'approvalRuleID': approvalRuleID
                }, approvalRule);
            }
            ...
            function _patch(approvalRuleID, partialApprovalRule, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/approvalrules/:approvalRuleID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'approvalRuleID': approvalRuleID
                }, partialApprovalRule);
            }
            ...
            function _delete(approvalRuleID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/approvalrules/:approvalRuleID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'approvalRuleID': approvalRuleID
                }, null);
            }
        ...
        function Buyers() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/buyers', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _get(buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID', {
                    'buyerID': buyerID
                }, null);
            }

            function _delete(buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, null);
            }

            function _create(company) {
                return startApiLoop('POST', '/v1/buyers', null, company);
            }

            function _patch(company, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, company);
            }

            function _update(company, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, company);
            }
        }
        ...
        function Categories() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters, depth, catalogID) {
                return startApiLoop('GET', '/v1/catalogs/:catalogID/categories', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get(),
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
            ...
            function _get(categoryID, catalogID) {
                ...
                return startApiLoop('GET', '/v1/catalogs/:catalogID/categories/:categoryID', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get(),
            ...
            function _create(category, catalogID) {
                return startApiLoop('POST', '/v1/catalogs/:catalogID/categories', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get()
                }, category);
            }

            function _update(categoryID, category, catalogID) {
                return startApiLoop('PUT', '/v1/catalogs/:catalogID/categories/:categoryID', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get(),
                    'categoryID': categoryID
                }, category);
            }
            ...
            function _patch(categoryID, category, catalogID) {
                return startApiLoop('PATCH', '/v1/catalogs/:catalogID/categories/:categoryID', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get(),
                    'categoryID': categoryID
                }, category);
            }
            ...
            function _delete(categoryID, catalogID) {
                return startApiLoop('DELETE', '/v1/catalogs/:catalogID/categories/:categoryID', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get(),
                    'categoryID': categoryID
                }, null);
            }
            ...
            function _listassignments(categoryID, userID, userGroupID, level, page, pageSize, buyerID, catalogID) {
                return startApiLoop('GET', '/v1/catalogs/:catalogID/categories/assignments', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get(),
                    'categoryID': categoryID,
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userID': userID,
            ...
            function _deleteassignment(categoryID, userID, userGroupID, buyerID, catalogID) {
                return startApiLoop('DELETE', '/v1/catalogs/:catalogID/categories/:categoryID/assignments', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get(),
                    'categoryID': categoryID,
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userID': userID,
            ...
            function _saveassignment(categoryAssignment, catalogID) {
                return startApiLoop('POST', '/v1/catalogs/:catalogID/categories/assignments', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get()
                }, categoryAssignment);
            }

            function _listproductassignments(categoryID, productID, page, pageSize, catalogID) {
                return startApiLoop('GET', '/v1/catalogs/:catalogID/categories/productassignments', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get(),
                    'categoryID': categoryID,
                    'productID': productID,
                    'page': page,
            ...
            function _saveproductassignment(productAssignment, catalogID) {
                return startApiLoop('POST', '/v1/catalogs/:catalogID/categories/productassignments', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get()
                }, productAssignment);
            }

            function _deleteproductassignment(categoryID, productID, catalogID) {
                return startApiLoop('DELETE', '/v1/catalogs/:catalogID/categories/:categoryID/productassignments/:productID', {
                    'catalogID': catalogID ? catalogID : CatalogID().Get(),
                    'categoryID': categoryID,
                    'productID': productID
                }, null);
        ...
        function CostCenters() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/costcenters', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
            ...
            function _get(costCenterID, buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID/costcenters/:costCenterID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
            ...
            function _create(costCenter, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/costcenters', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, costCenter);
            }

            function _update(costCenterID, costCenter, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/costcenters/:costCenterID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'costCenterID': costCenterID
                }, costCenter);
            }
            ...
            function _patch(costCenterID, costCenter, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/costcenters/:costCenterID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'costCenterID': costCenterID
                }, costCenter);
            }
            ...
            function _delete(costCenterID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/costcenters/:costCenterID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'costCenterID': costCenterID
                }, null);
            }
            ...
            function _listassignments(costCenterID, userID, userGroupID, level, page, pageSize, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/costcenters/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'costCenterID': costCenterID,
                    'userID': userID,
                    'userGroupID': userGroupID,
            ...
            function _deleteassignment(costCenterID, userID, userGroupID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/costcenters/:costCenterID/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'costCenterID': costCenterID,
                    'userID': userID,
                    'userGroupID': userGroupID
            ...
            function _saveassignment(assignment, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/costcenters/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, assignment);
            }
        }
        ...
        function MesageSenders() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/MessageSenders', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _get(messageSenderID) {
                ...
                return startApiLoop('GET', '/v1/MessageSenders/:messageSenderID', {
                    'messageSenderID': messageSenderID
                }, null);
            }

            function _listassignments(messageSenderID, userID, userGroupID, level, page, pageSize, buyerID) {
                return startApiLoop('GET', '/v1/MessageSenders/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'messageSenderID': messageSenderID,
                    'userID': userID,
                    'userGroupID': userGroupID,
            ...
            function _deleteassignment(messageSenderID, userID, userGroupID, buyerID) {
                return startApiLoop('DELETE', '/v1/MessageSenders/:messageSenderID/assignments', {
                    'messageSenderID': messageSenderID,
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userID': userID,
                    'userGroupID': userGroupID
            ...
            function _saveassignment(assignment) {
                return startApiLoop('POST', '/v1/MessageSenders/assignments', null, assignment);
            }

            function _listcclistenerassignments(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/MessageSenders/CCListenerAssignments', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _savecclistenerassignment(assignment) {
                return startApiLoop('POST', '/v1/MessageSenders/CCListenerAssignments', null, assignment);
            }
        }
        ...
        function Promotions() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/promotions', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _get(promotionID) {
                ...
                return startApiLoop('GET', '/v1/promotions/:promotionID', {
                    'promotionID': promotionID
                }, null);
            }

            function _create(promo) {
                return startApiLoop('POST', '/v1/promotions', null, promo);
            }

            function _update(promotionID, promo) {
                return startApiLoop('PUT', '/v1/promotions/:promotionID', {
                    'promotionID': promotionID
                }, promo);
            }

            function _patch(promotionID, partialPromotion) {
                return startApiLoop('PATCH', '/v1/promotions/:promotionID', {
                    'promotionID': promotionID
                }, partialPromotion);
            }

            function _delete(promotionID) {
                return startApiLoop('DELETE', '/v1/promotions/:promotionID', {
                    'promotionID': promotionID
                }, null);
            }

            function _listassignments(promotionID, userID, userGroupID, level, page, pageSize, buyerID) {
                return startApiLoop('GET', '/v1/promotions/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'promotionID': promotionID,
                    'userID': userID,
                    'userGroupID': userGroupID,
            ...
            function _saveassignment(assignment) {
                return startApiLoop('POST', '/v1/promotions/assignments', null, assignment);
            }

            function _deleteassignment(promotionID, userID, userGroupID, buyerID) {
                return startApiLoop('DELETE', '/v1/promotions/:promotionID/assignments', {
                    'promotionID': promotionID,
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userID': userID,
                    'userGroupID': userGroupID
        ...
        function CreditCards() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/creditcards', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
            ...
            function _get(creditCardID, buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID/creditcards/:creditCardID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
            ...
            function _create(card, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/creditcards', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, card);
            }

            function _update(creditCardID, card, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/creditcards/:creditCardID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'creditCardID': creditCardID
                }, card);
            }
            ...
            function _patch(creditCardID, card, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/creditcards/:creditCardID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'creditCardID': creditCardID
                }, card);
            }
            ...
            function _delete(creditCardID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/creditcards/:creditCardID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'creditCardID': creditCardID
                }, null);
            }
            ...
            function _listassignments(creditCardID, userID, userGroupID, level, page, pageSize, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/creditcards/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'creditCardID': creditCardID,
                    'userID': userID,
                    'userGroupID': userGroupID,
            ...
            function _saveassignment(assignment, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/creditcards/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, assignment);
            }

            function _deleteassignment(creditCardID, userID, userGroupID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/creditcards/:creditCardID/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'creditCardID': creditCardID,
                    'userID': userID,
                    'userGroupID': userGroupID
        ...
        function SecurityProfiles() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/securityprofiles', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _get(securityProfileID) {
                ...
                return startApiLoop('GET', '/v1/securityprofiles/:securityProfileID', {
                    'securityProfileID': securityProfileID
                }, null);
            }

            function _listassignments(securityProfileID, userID, userGroupID, level, page, pageSize, buyerID) {
                return startApiLoop('GET', '/v1/securityprofiles/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'securityProfileID': securityProfileID,
                    'userID': userID,
                    'userGroupID': userGroupID,
            ...
            function _deleteassignment(securityProfileID, userID, userGroupID, buyerID) {
                return startApiLoop('DELETE', '/v1/securityprofiles/:securityProfileID/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'securityProfileID': securityProfileID,
                    'userID': userID,
                    'userGroupID': userGroupID
            ...
            function _saveassignment(assignment) {
                return startApiLoop('POST', '/v1/securityprofiles/assignments', null, assignment);
            }
        }
        ...
        function Payments() {
            ...
            function _get(orderID, paymentID, buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID/orders/:orderID/payments/:paymentID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'paymentID': paymentID
                }, null);
            ...
            function _list(orderID, search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/orders/:orderID/payments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'search': search,
                    'page': page,
            ...
            function _create(orderID, payment, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/orders/:orderID/payments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, payment);
            }
            ...
            function _update(orderID, paymentID, payment, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/orders/:orderID/payments/:paymentID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'paymentID': paymentID
                }, payment);
            ...
            function _patch(orderID, paymentID, partialPayment, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/orders/:orderID/payments/:paymentID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'paymentID': paymentID
                }, partialPayment);
            ...
            function _delete(orderID, paymentID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/orders/:orderID/payments/:paymentID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'paymentID': paymentID
                }, null);
            ...
            function _createtransaction(orderID, paymentID, transaction, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/orders/:orderID/payments/:paymentID/transactions', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'paymentID': paymentID
                }, transaction);
            ...
            function _updatetransaction(orderID, paymentID, transactionID, transaction, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/orders/:orderID/payments/:paymentID/transactions/:transactionID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'paymentID': paymentID,
            ...
            function _patchtransaction(orderID, paymentID, transactionID, partialTransaction, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/orders/:orderID/payments/:paymentID/transactions/:transactionID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'paymentID': paymentID,
                    'transactionID': transactionID
            ...
            function _deletetransaction(orderID, paymentID, transactionID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/orders/:orderID/payments/:paymentID/transactions/:transactionID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'paymentID': paymentID,
                    'transactionID': transactionID
        ...
        function Specs() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/specs', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _get(specID) {
                ...
                return startApiLoop('GET', '/v1/specs/:specID', {
                    'specID': specID
                }, null);
            }

            function _patch(specID, spec) {
                return startApiLoop('PATCH', '/v1/specs/:specID', {
                    'specID': specID
                }, spec);
            }

            function _update(specID, spec) {
                return startApiLoop('PUT', '/v1/specs/:specID', {
                    'specID': specID
                }, spec);
            }

            function _create(spec) {
                return startApiLoop('POST', '/v1/specs', null, spec);
            }

            function _delete(specID) {
                return startApiLoop('DELETE', '/v1/specs/:specID', {
                    'specID': specID
                }, null);
            }

            function _listproductassignments(specID, productID, page, pageSize) {
                return startApiLoop('GET', '/v1/specs/productassignments', {
                    'specID': specID,
                    'productID': productID,
                    'page': page,
                    'pageSize': pageSize
            ...
            function _deleteproductassignment(specID, productID) {
                return startApiLoop('DELETE', '/v1/specs/:specID/productassignments/:productID', {
                    'specID': specID,
                    'productID': productID
                }, null);
            }
            ...
            function _saveproductassignment(productAssignment) {
                return startApiLoop('POST', '/v1/specs/productassignments', null, productAssignment);
            }

            function _createoption(specID, option) {
                return startApiLoop('POST', '/v1/specs/:specID/options', {
                    'specID': specID
                }, option);
            }

            function _listoptions(specID, search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/specs/:specID/options', {
                    'specID': specID,
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
            ...
            function _updateoption(specID, optionID, option) {
                return startApiLoop('PUT', '/v1/specs/:specID/options/:optionID', {
                    'specID': specID,
                    'optionID': optionID
                }, option);
            }
            ...
            function _patchoption(specID, optionID, option) {
                return startApiLoop('PATCH', '/v1/specs/:specID/options/:optionID', {
                    'specID': specID,
                    'optionID': optionID
                }, option);
            }
            ...
            function _getoption(specID, optionID) {
                return startApiLoop('GET', '/v1/specs/:specID/options/:optionID', {
                    'specID': specID,
                    'optionID': optionID
                }, null);
            }
            ...
            function _deleteoption(specID, optionID) {
                return startApiLoop('DELETE', '/v1/specs/:specID/options/:optionID', {
                    'specID': specID,
                    'optionID': optionID
                }, null);
            }
        ...
        function UserGroups() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/usergroups', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
            ...
            function _get(userGroupID, buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID/usergroups/:userGroupID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userGroupID': userGroupID
                }, null);
            }
            ...
            function _update(userGroupID, group, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/usergroups/:userGroupID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userGroupID': userGroupID
                }, group);
            }
            ...
            function _patch(userGroupID, group, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/usergroups/:userGroupID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userGroupID': userGroupID
                }, group);
            }
            ...
            function _create(group, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/usergroups', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, group);
            }

            function _delete(userGroupID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/usergroups/:userGroupID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userGroupID': userGroupID
                }, null);
            }
            ...
            function _listuserassignments(userGroupID, userID, page, pageSize, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/usergroups/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userGroupID': userGroupID,
                    'userID': userID,
                    'page': page,
            ...
            function _deleteuserassignment(userGroupID, userID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/usergroups/:userGroupID/assignments/:userID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userGroupID': userGroupID,
                    'userID': userID
                }, null);
            ...
            function _saveuserassignment(userGroupAssignment, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/usergroups/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, userGroupAssignment);
            }
        }
        ...
        function LineItems() {
            ...
            function _get(orderID, lineItemID, buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID/orders/:orderID/lineitems/:lineItemID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
            ...
            function _list(orderID, search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/orders/:orderID/lineitems', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'search': search,
                    'page': page,
            ...
            function _create(orderID, lineItem, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/orders/:orderID/lineitems', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, lineItem);
            }
            ...
            function _update(orderID, lineItemID, lineItem, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/orders/:orderID/lineitems/:lineItemID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'lineItemID': lineItemID
                }, lineItem);
            ...
            function _patch(orderID, lineItemID, partialLineItem, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/orders/:orderID/lineitems/:lineItemID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'lineItemID': lineItemID
                }, partialLineItem);
            ...
            function _delete(orderID, lineItemID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/orders/:orderID/lineitems/:lineItemID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'lineItemID': lineItemID
                }, null);
            ...
            function _setshippingaddress(orderID, lineItemID, address, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/orders/:orderID/lineitems/:lineItemID/shipto', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'lineItemID': lineItemID
                }, address);
            ...
            function _patchshippingaddress(orderID, lineItemID, partialAddress, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/orders/:orderID/lineitems/:lineItemID/shipto', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'lineItemID': lineItemID
                }, partialAddress);
        ...
        function Me() {
            ...
            function _get() {
                return startApiLoop('GET', '/v1/me', null, null);
            }

            function _update(user) {
                return startApiLoop('PUT', '/v1/me', null, user);
            }

            function _patch(user) {
                return startApiLoop('PATCH', '/v1/me', null, user);
            }

            function _listcostcenters(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/me/costcenters', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _listusergroups(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/me/usergroups', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _listaddresses(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/me/addresses', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _createaddress(address) {
                return startApiLoop('POST', '/v1/me/addresses', null, address);
            }

            function _getaddress(addressID) {
                return startApiLoop('GET', '/v1/me/addresses/:addressID', {
                    'addressID': addressID
                }, null);
            }

            function _updateaddress(addressID, address) {
                return startApiLoop('PUT', '/v1/me/addresses/:addressID', {
                    'addressID': addressID
                }, address);
            }

            function _patchaddress(addressID, address) {
                return startApiLoop('PATCH', '/v1/me/addresses/:addressID', {
                    'addressID': addressID
                }, address);
            }

            function _deleteaddress(addressID) {
                return startApiLoop('DELETE', '/v1/me/addresses/:addressID', {
                    'addressID': addressID
                }, null);
            }

            function _createcreditcard(creditCard) {
                return startApiLoop('POST', '/v1/me/creditcards', null, creditCard);
            }

            function _listcreditcards(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/me/creditcards', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _getcreditcard(creditcardID) {
                return startApiLoop('GET', '/v1/me/creditcards/:creditcardID', {
                    'creditcardID': creditcardID
                }, null);
            }

            function _updatecreditcard(creditcardID, creditCard) {
                return startApiLoop('PUT', '/v1/me/creditcards/:creditcardID', {
                    'creditcardID': creditcardID
                }, creditCard);
            }

            function _patchcreditcard(creditcardID, creditCard) {
                return startApiLoop('PATCH', '/v1/me/creditcards/:creditcardID', {
                    'creditcardID': creditcardID
                }, creditCard);
            }

            function _deletecreditcard(creditcardID) {
                return startApiLoop('DELETE', '/v1/me/creditcards/:creditcardID', {
                    'creditcardID': creditcardID
                }, null);
            }

            function _listcategories(search, page, pageSize, searchOn, sortBy, filters, depth, catalogID) {
                return startApiLoop('GET', '/v1/me/categories', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _listproducts(search, page, pageSize, searchOn, sortBy, filters, categoryID, catalogID) {
                return startApiLoop('GET', '/v1/me/products', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _getproduct(productID) {
                return startApiLoop('GET', '/v1/me/products/:productID', {
                    'productID': productID
                }, null);
            }

            function _listspecs(productID, search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/me/products/:productID/specs', {
                    'productID': productID,
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
            ...
            function _getspec(productID, specID) {
                return startApiLoop('GET', '/v1/me/products/:productID/specs/:specID', {
                    'productID': productID,
                    'specID': specID
                }, null);
            }
            ...
            function _listoutgoingorders(search, page, pageSize, searchOn, sortBy, filters, from, to) {
                return startApiLoop('GET', '/v1/me/orders/outgoing', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _listincomingorders(search, page, pageSize, searchOn, sortBy, filters, from, to) {
                return startApiLoop('GET', '/v1/me/orders/incoming', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _getorder(orderID) {
                return startApiLoop('GET', '/v1/me/orders/:orderID', {
                    'orderID': orderID
                }, null);
            }

            function _listpromotions(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/me/promotions', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _getpromotion(promotionID) {
                return startApiLoop('GET', '/v1/me/promotions/:promotionID', {
                    'promotionID': promotionID
                }, null);
            }

            function _createfromtempuser(user, tempUserToken) {
                return startApiLoop('PUT', '/v1/me', {
        ...
        function Orders() {
            ...
            function _get(orderID, buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID/orders/:orderID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, null);
            }
            ...
            function _listoutgoing(from, to, search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/orders/outgoing', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'from': from,
                    'to': to,
                    'search': search,
            ...
            function _listincoming(from, to, search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/orders/incoming', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'from': from,
                    'to': to,
                    'search': search,
            ...
            function _listapprovals(orderID, search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/orders/:orderID/approvals', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'search': search,
                    'page': page,
            ...
            function _listeligibleapprovers(orderID, search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/orders/:orderID/eligibleapprovers', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'search': search,
                    'page': page,
            ...
            function _create(order, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/orders', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, order);
            }

            function _update(orderID, order, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/orders/:orderID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, order);
            }
            ...
            function _patch(orderID, partialOrder, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/orders/:orderID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, partialOrder);
            }
            ...
            function _delete(orderID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/orders/:orderID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, null);
            }
            ...
            function _submit(orderID, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/orders/:orderID/submit', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, null);
            }
            ...
            function _approve(orderID, comments, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/orders/:orderID/approve', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'comments': comments
                }, null);
            ...
            function _decline(orderID, comments, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/orders/:orderID/decline', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'comments': comments
                }, null);
            ...
            function _cancel(orderID, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/orders/:orderID/cancel', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, null);
            }
            ...
            function _ship(orderID, shipment, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/orders/:orderID/ship', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, shipment);
            }
            ...
            function _setshippingaddress(orderID, address, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/orders/:orderID/shipto', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, address);
            }
            ...
            function _patchshippingaddress(orderID, address, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/orders/:orderID/shipto', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, address);
            }
            ...
            function _setbillingaddress(orderID, address, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/orders/:orderID/billto', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, address);
            }
            ...
            function _patchbillingaddress(orderID, address, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/orders/:orderID/billto', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID
                }, address);
            }
            ...
            function _addpromotion(orderID, promoCode, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/orders/:orderID/promotions/:promoCode', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'promoCode': promoCode
                }, null);
            ...
            function _listpromotions(orderID, search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/orders/:orderID/promotions', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'search': search,
                    'page': page,
            ...
            function _removepromotion(orderID, promoCode, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/orders/:orderID/promotions/:promoCode', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'promoCode': promoCode
                }, null);
            ...
            function _transfertempuserorder(tempUserToken, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/orders', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'tempUserToken': tempUserToken
                }, null);
            }
        ...
        function PasswordResets() {
            ...
            function _sendverificationcode(passwordResetRequest) {
                return startApiLoop('POST', '/v1/password/reset', null, passwordResetRequest);
            }

            function _resetpassword(verificationCode, passwordReset) {
                return startApiLoop('PUT', '/v1/password/reset/:verificationCode', {
        ...
        function PriceSchedules() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/priceschedules', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _get(priceScheduleID) {
                ...
                return startApiLoop('GET', '/v1/priceschedules/:priceScheduleID', {
                    'priceScheduleID': priceScheduleID
                }, null);
            }

            function _create(priceSchedule) {
                return startApiLoop('POST', '/v1/priceschedules', null, priceSchedule);
            }

            function _patch(priceScheduleID, priceSchedule) {
                return startApiLoop('PATCH', '/v1/priceschedules/:priceScheduleID', {
                    'priceScheduleID': priceScheduleID
                }, priceSchedule);
            }

            function _update(priceScheduleID, priceSchedule) {
                return startApiLoop('PUT', '/v1/priceschedules/:priceScheduleID', {
                    'priceScheduleID': priceScheduleID
                }, priceSchedule);
            }

            function _delete(priceScheduleID) {
                return startApiLoop('DELETE', '/v1/priceschedules/:priceScheduleID', {
                    'priceScheduleID': priceScheduleID
                }, null);
            }

            function _savepricebreak(priceScheduleID, priceBreak) {
                return startApiLoop('POST', '/v1/priceschedules/:priceScheduleID/PriceBreaks', {
                    'priceScheduleID': priceScheduleID
                }, priceBreak);
            }

            function _deletepricebreak(priceScheduleID, quantity) {
                return startApiLoop('DELETE', '/v1/priceschedules/:priceScheduleID/PriceBreaks', {
                    'priceScheduleID': priceScheduleID,
                    'quantity': quantity
                }, null);
            }
        ...
        function Shipments() {
            ...
            function _get(shipmentID, buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID/shipments/:shipmentID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
            ...
            function _list(orderID, search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/shipments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'orderID': orderID,
                    'search': search,
                    'page': page,
            ...
            function _create(shipment, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/shipments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, shipment);
            }

            function _update(shipmentID, shipment, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/shipments/:shipmentID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'shipmentID': shipmentID
                }, shipment);
            }
            ...
            function _patch(shipmentID, shipment, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/shipments/:shipmentID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'shipmentID': shipmentID
                }, shipment);
            }
            ...
            function _delete(shipmentID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/shipments/:shipmentID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'shipmentID': shipmentID
                }, null);
            }
            ...
            function _saveitem(shipmentID, item, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/shipments/:shipmentID/items', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'shipmentID': shipmentID
                }, item);
            }
            ...
            function _deleteitem(shipmentID, orderID, lineItemID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/shipments/:shipmentID/items/:orderID/:lineItemID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'shipmentID': shipmentID,
                    'orderID': orderID,
                    'lineItemID': lineItemID
        ...
        function SpendingAccounts() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/spendingaccounts', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
            ...
            function _get(spendingAccountID, buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID/spendingaccounts/:spendingAccountID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
            ...
            function _create(spendingAccount, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/spendingaccounts', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, spendingAccount);
            }

            function _update(spendingAccountID, spendingAccount, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/spendingaccounts/:spendingAccountID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'spendingAccountID': spendingAccountID
                }, spendingAccount);
            }
            ...
            function _patch(spendingAccountID, spendingAccount, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/spendingaccounts/:spendingAccountID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'spendingAccountID': spendingAccountID
                }, spendingAccount);
            }
            ...
            function _delete(spendingAccountID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/spendingaccounts/:spendingAccountID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'spendingAccountID': spendingAccountID
                }, null);
            }
            ...
            function _listassignments(spendingAccountID, userID, userGroupID, level, page, pageSize, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/spendingaccounts/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'spendingAccountID': spendingAccountID,
                    'userID': userID,
                    'userGroupID': userGroupID,
            ...
            function _saveassignment(assignment, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/spendingaccounts/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, assignment);
            }

            function _deleteassignment(spendingAccountID, userID, userGroupID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/spendingaccounts/:spendingAccountID/assignments', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'spendingAccountID': spendingAccountID,
                    'userID': userID,
                    'userGroupID': userGroupID
        ...
        function Products() {
            ...
            function _list(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/products', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _get(productID) {
                ...
                return startApiLoop('GET', '/v1/products/:productID', {
                    'productID': productID
                }, null);
            }

            function _update(productID, product) {
                return startApiLoop('PUT', '/v1/products/:productID', {
                    'productID': productID
                }, product);
            }

            function _patch(productID, product) {
                return startApiLoop('PATCH', '/v1/products/:productID', {
                    'productID': productID
                }, product);
            }

            function _create(product) {
                return startApiLoop('POST', '/v1/products', null, product);
            }

            function _delete(productID) {
                return startApiLoop('DELETE', '/v1/products/:productID', {
                    'productID': productID
                }, null);
            }

            function _generatevariants(productID, overwriteExisting) {
                return startApiLoop('POST', '/v1/products/:productID/variants/generate', {
                    'productID': productID,
            ...
            function _listvariants(productID, search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/products/:productID/variants', {
                    'productID': productID,
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
            ...
            function _updatevariant(productID, variantID, variant) {
                return startApiLoop('PUT', '/v1/products/:productID/variants/:variantID', {
                    'productID': productID,
                    'variantID': variantID
                }, variant);
            }
            ...
            function _patchvariant(productID, variantID, variant) {
                return startApiLoop('PATCH', '/v1/products/:productID/variants/:variantID', {
                    'productID': productID,
                    'variantID': variantID
                }, variant);
            }
            ...
            function _getvariant(productID, variantID) {
                return startApiLoop('GET', '/v1/products/:productID/variants/:variantID', {
                    'productID': productID,
                    'variantID': variantID
                }, null);
            }
            ...
            function _listvariantinventory(productID, search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/products/:productID/variants/inventory', {
                    'productID': productID,
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
            ...
            function _getvariantinventory(productID, variantID) {
                return startApiLoop('GET', '/v1/products/:productID/variants/inventory/:variantID', {
                    'productID': productID,
                    'variantID': variantID
                }, null);
            }
            ...
            function _updatevariantinventory(productID, variantID, inventory) {
                return startApiLoop('PUT', '/v1/products/:productID/variants/inventory/:variantID/:inventory', {
                    'productID': productID,
                    'variantID': variantID,
                    'inventory': inventory
                }, null);
            ...
            function _listinventory(search, page, pageSize, searchOn, sortBy, filters) {
                return startApiLoop('GET', '/v1/products/inventory', {
                    'search': search,
                    'page': page,
                    'pageSize': pageSize,
                    'searchOn': searchOn,
            ...
            function _getinventory(productID) {
                return startApiLoop('GET', '/v1/products/:productID/inventory', {
                    'productID': productID
                }, null);
            }

            function _updateinventory(productID, inventory) {
                return startApiLoop('PUT', '/v1/products/:productID/inventory/:inventory', {
                    'productID': productID,
                    'inventory': inventory
                }, null);
            }
            ...
            function _saveassignment(productAssignment) {
                return startApiLoop('POST', '/v1/products/assignments', null, productAssignment);
            }

            function _listassignments(productID, userID, userGroupID, level, priceScheduleID, page, pageSize, buyerID) {
                return startApiLoop('GET', '/v1/products/assignments', {
                    'productID': productID,
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userID': userID,
                    'userGroupID': userGroupID,
            ...
            function _deleteassignment(productID, userID, userGroupID, buyerID) {
                return startApiLoop('DELETE', '/v1/products/:productID/assignments/:buyerID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'productID': productID,
                    'userID': userID,
                    'userGroupID': userGroupID
        ...
        function Users() {
            ...
            function _list(userGroupID, search, page, pageSize, searchOn, sortBy, filters, buyerID) {
                return startApiLoop('GET', '/v1/buyers/:buyerID/users', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userGroupID': userGroupID,
                    'search': search,
                    'page': page,
            ...
            function _get(userID, buyerID) {
                ...
                return startApiLoop('GET', '/v1/buyers/:buyerID/users/:userID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userID': userID
                }, null);
            }
            ...
            function _update(userID, user, buyerID) {
                return startApiLoop('PUT', '/v1/buyers/:buyerID/users/:userID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userID': userID
                }, user);
            }
            ...
            function _create(user, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/users', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get()
                }, user);
            }

            function _delete(userID, buyerID) {
                return startApiLoop('DELETE', '/v1/buyers/:buyerID/users/:userID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userID': userID
                }, null);
            }
            ...
            function _patch(userID, user, buyerID) {
                return startApiLoop('PATCH', '/v1/buyers/:buyerID/users/:userID', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userID': userID
                }, user);
            }
            ...
            function _getaccesstoken(userID, tokenRequest, buyerID) {
                return startApiLoop('POST', '/v1/buyers/:buyerID/users/:userID/accesstoken', {
                    'buyerID': buyerID ? buyerID : BuyerID().Get(),
                    'userID': userID
                }, tokenRequest);
            }
        ...
        function startApiLoop(method, routingUrl, originalParameters, requestBody) {
            var allData = [];
            var meta;
            var defer = $q.defer();
            var q = [];
            ...
            makeApiCall(method, routingUrl, parameters, requestBody).then(function (resp) {
                ...
                if (meta.TotalPages > 1) {
                     for (var i = 2; i <= meta.TotalPages; i++) {   
                        parameters.page++;
                        q.push(
                            makeApiCall(method, routingUrl, parameters, requestBody).then(function (_resp) {
                ...
                $q.all(q).then(function () {
                    defer.resolve({ Items: allData, Meta: resp.Meta });
                });
            });
